        ...
        <div class="demo-panel" id="registerDemo">
            ...
            <div class="registration-box">
                ...
                <div class="contact-buttons">
                    ...
                    <a href="https://hajikhamis6.github.io/O.C-app/" target="_blank" style="text-decoration: none; width: 100%;" id="ocLiveLink">
            ...
            <div class="footer-grid">
                <div class="footer-col">
                    ...
                    <div style="margin-top:16px; display: flex; flex-direction: column; gap: 8px;">
                        <a href="https://hajikhamis6.github.io/O.C-app/" target="_blank" class="phone-footer-link" style="background:#9b6d3c; color:white; border:none;" id="footerOCLink">
